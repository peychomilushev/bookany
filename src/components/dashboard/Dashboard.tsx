...
export function Dashboard() {
  ...
  // ✅ Always define all hooks before any return
  useEffect(() => {
  ...
  }, []); // intentionally empty deps (runs only once)

  // ✅ useMemo declared safely before any conditional returns
  ...
  // ✅ Return blocks (purely conditional rendering — no hooks inside)
